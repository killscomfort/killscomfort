...
export function WhoIs() {
  return (
    <section
      id="whois"
      className="section-padding !py-14 lg:!py-20 bg-transparent"
    >
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="relative mx-auto max-w-lg overflow-visible lg:max-w-xl">
          <div
            data-whois-image
            className="relative overflow-hidden bg-near-black shadow-[0_0_80px_rgba(0,0,0,0.45)]"
          >
            <Image
